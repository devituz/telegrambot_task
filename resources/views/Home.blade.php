...
<div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 pb-6">
    <div class="flex items-center mb-4">
        ...
        <div>
            ...
            <div class="text-blue-100 text-sm" id="user-fullname">Yuklanmoqda...</div>
        </div>
    </div>
        ...
        @foreach ($groups as $group)
            <div class="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                ...
                <div class="flex items-center justify-between mt-3">
                    ...
                    <button class="bg-blue-500 text-white px-3 py-1 rounded-full text-sm font-medium hover:bg-blue-600 transition-colors">
